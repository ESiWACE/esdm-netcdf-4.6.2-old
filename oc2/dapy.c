...
#line 91 "dap.y" /* yacc.c:1646  */
    {
      if (((yyval) = dap_makestructure(parsestate, (yyvsp[-2]), (yyvsp[-1]), (yyvsp[-4]))) == null) {
        YYABORT;
      }
    }
...
#line 93 "dap.y" /* yacc.c:1646  */
    {
      if (((yyval) = dap_makesequence(parsestate, (yyvsp[-1]), (yyvsp[-3]))) == null) {
        YYABORT;
      }
    }
...
#line 96 "dap.y" /* yacc.c:1646  */
    {
      if (((yyval) = dap_makegrid(parsestate, (yyvsp[-1]), (yyvsp[-6]), (yyvsp[-3]))) == null) {
        YYABORT;
      }
    }
...
#line 98 "dap.y" /* yacc.c:1646  */
    {
      dapsemanticerror(parsestate, OC_EBADTYPE, "Unrecognized type");
      YYABORT;
    }
...
#line 124 "dap.y" /* yacc.c:1646  */
    {
      dapsemanticerror(parsestate, OC_EDIMSIZE, "Illegal dimension declaration");
      YYABORT;
    }
...
#line 130 "dap.y" /* yacc.c:1646  */
    {
      dapsemanticerror(parsestate, OC_EDDS, "Illegal dataset declaration");
      YYABORT;
    }
...
#line 138 "dap.y" /* yacc.c:1646  */
    {
      dapsemanticerror(parsestate, OC_EDAS, "Illegal DAS body");
      YYABORT;
    }
...
#line 168 "dap.y" /* yacc.c:1646  */
    {
      dapsemanticerror(parsestate, OC_EDAS, "Illegal attribute");
      YYABORT;
    }
