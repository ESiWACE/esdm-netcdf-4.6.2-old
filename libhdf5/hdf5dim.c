 ...
 * @author Ed Hartnett
 */
int NC4_def_dim(int ncid, const char *name, size_t len, int *idp) {
  NC *nc;
  NC_GRP_INFO_T *grp;
  NC_FILE_INFO_T *h5;
  NC_DIM_INFO_T *dim;
 ...
 * @author Ed Hartnett
 */
int NC4_inq_dim(int ncid, int dimid, char *name, size_t *lenp) {
  NC *nc;
  NC_FILE_INFO_T *h5;
 ...
 * @author Ed Hartnett
 */
int NC4_rename_dim(int ncid, int dimid, const char *name) {
  NC *nc;
  NC_GRP_INFO_T *grp;
  NC_DIM_INFO_T *dim;
