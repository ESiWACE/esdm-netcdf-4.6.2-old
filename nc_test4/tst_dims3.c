...
#define NUM_VRT 3
  ...
  printf("*** testing defining dimensions and coord variables in different orders in root group...");
  {
    ...
    if (time_dimid_in == lev_dimid_in || time_dimid_in == g2lev_dimid_in || time_dimid_in == g2vrt_dimid_in || lev_dimid_in == g2lev_dimid_in || lev_dimid_in == g2vrt_dimid_in || g2lev_dimid_in == g2vrt_dimid_in) ERR;
