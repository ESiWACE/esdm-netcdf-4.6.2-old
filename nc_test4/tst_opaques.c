...
int main(int argc, char **argv) {
  ...
  printf("*** testing scalar opaque variable...");
  {
    ...
    if (strcmp(name_in, TYPE_NAME) || base_size_in != BASE_SIZE || base_nc_type_in != 0 || nfields_in != 0 || class_in != NC_OPAQUE) ERR;
  ...
  printf("*** testing opaque variable...");
  {
    ...
    if (ndims != 1 || strcmp(var_name, VAR_NAME) || dimids_var[0] != dimids[0] || natts != 0) ERR;
...
#define NUM_TYPES 3
    ...
    for (i = 0; i < NUM_TYPES; i++) {
      ...
      if (strcmp(name_in, type_name[i]) || base_size_in != TYPE_SIZE1 || base_nc_type_in != 0 || nfields_in != 0 || class_in != NC_OPAQUE) ERR;
