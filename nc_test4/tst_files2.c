...
*/
int get_mem_used1(int *mem_used) {
...
#define MAX_DIMS 4
int create_sample_file(char *file_name, int ndims, int *dim_len,
...
#define NUM_TRIES 6
    ...
    for (t = 0; t < NUM_TRIES; t++) {
      ...
      close_us = ((int)close_diff_time.tv_sec * MILLION + (int)close_diff_time.tv_usec) / num_files[t];
