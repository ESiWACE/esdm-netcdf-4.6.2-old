...
int check_cf_metadata(int ncid) {
  ...
  if (strcmp(var_name_in, T_NAME) || xtype_in != NC_FLOAT || ndims_in != NDIMS || dimids_in[0] != 2 || dimids_in[1] != 1 || dimids_in[2] != 0 || natts_in != 3) ERR_RET;
  ...
  if (strcmp(var_name_in, XC_NAME) || xtype_in != NC_FLOAT || ndims_in != 1 || dimids_in[0] != 0 || natts_in != 3) ERR_RET;
  ...
  if (strcmp(var_name_in, YC_NAME) || xtype_in != NC_FLOAT || ndims_in != 1 || dimids_in[0] != 1 || natts_in != 3) ERR_RET;
  ...
  if (strcmp(var_name_in, LEV_NAME) || xtype_in != NC_FLOAT || ndims_in != 1 || dimids_in[0] != 2 || natts_in != 2) ERR_RET;
  ...
  if (strcmp(var_name_in, LON_NAME) || xtype_in != NC_FLOAT || ndims_in != COORD_NDIMS || dimids_in[0] != 1 || dimids_in[1] != 0 || natts_in != 2) ERR_RET;
  ...
  if (strcmp(var_name_in, LAT_NAME) || xtype_in != NC_FLOAT || ndims_in != COORD_NDIMS || dimids_in[0] != 1 || dimids_in[1] != 0 || natts_in != 2) ERR_RET;
