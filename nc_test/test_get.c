...
int test_nc_get_var1_schar(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_uchar(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_short(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_long(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_float(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_double(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_ushort(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_uint(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_longlong(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var1_ulonglong(void) {
  int i, err, ncid, cdf_format;
  int nok = 0;    /* count of valid comparisons */
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
...
int test_nc_get_var_uchar(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_var_schar(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_var_short(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_var_float(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_var_double(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_var_ushort(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_var_longlong(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_var_ulonglong(void) {
  int i, err, ncid, cdf_format;
  int allInExtRange; /* all values within range of external data type */
  int allInIntRange; /* all values within range of internal data type */
  int nok = 0;       /* count of valid comparisons */
...
int test_nc_get_vara_text(void) {
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_TEXT) && 1) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_uchar(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_UCHAR) && (expect[0] >= uchar_min && expect[0] <= uchar_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
#if !defined(USE_PNETCDF) || (PNETCDF_VERSION_MAJOR == 1 && PNETCDF_VERSION_MINOR > 7)
...
int test_nc_get_vara_schar(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_SCHAR) && (expect[0] >= schar_min && expect[0] <= schar_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_short(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_SHORT) && (expect[0] >= short_min && expect[0] <= short_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_int(void) {
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_INT) && (expect[0] >= int_min && expect[0] <= int_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_long(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_LONG) && (expect[0] >= long_min && expect[0] <= long_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_float(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_FLOAT) && (expect[0] >= float_min && expect[0] <= float_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_double(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_DOUBLE) && (expect[0] >= double_min && expect[0] <= double_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_ushort(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_USHORT) && (expect[0] >= ushort_min && expect[0] <= ushort_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_uint(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_UINT) && (expect[0] >= uint_min && expect[0] <= uint_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_longlong(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_LONGLONG) && (expect[0] >= longlong_min && expect[0] <= longlong_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vara_ulonglong(void) {
  int i, k, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  int nok = 0;       /* count of valid comparisons */
  ...
  for (i = 0; i < numVars; i++) {
    ...
    if (!canConvert) {
      ...
      if (inRange3(cdf_format, expect[0], var_type[i], NCT_ULONGLONG) && (expect[0] >= ulonglong_min && expect[0] <= ulonglong_max)) {
        IF(err != NC_NOERR)
        error("expecting NC_NOERR but got %s", nc_err_code_name(err));
      }
...
int test_nc_get_vars_uchar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_schar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_short(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_long(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_float(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_double(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_ushort(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_uint(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_longlong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_vars_ulonglong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_uchar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_schar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_short(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_long(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_float(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_double(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_ushort(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_uint(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_longlong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_varm_ulonglong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format;
  int allInExtRange; /* all values within external range? */
  int allInIntRange; /* all values within internal range? */
  ptrdiff_t nstarts; /* number of different starts */
...
int test_nc_get_att_uchar(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
...
int test_nc_get_att_schar(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
...
int test_nc_get_att_short(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
...
int test_nc_get_att_float(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
...
int test_nc_get_att_double(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
...
int test_nc_get_att_ushort(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
...
int test_nc_get_att_longlong(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
...
int test_nc_get_att_ulonglong(void) {
  int i, j, err, ncid, cdf_format;
  size_t k, ndx[1];
  int allInExtRange;
  int allInIntRange;
