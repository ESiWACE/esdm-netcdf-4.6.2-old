 ...
 */
text hash_text(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
 ...
 *  ensure hash value within range for internal TYPE
 */
uchar hash_uchar(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
const nct_itype itype) {
 ...
 *  ensure hash value within range for internal TYPE
 */
schar hash_schar(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
const nct_itype itype) {
 ...
 *  ensure hash value within range for internal TYPE
 */
short hash_short(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
const nct_itype itype) {
 ...
 *  ensure hash value within range for internal TYPE
 */
int hash_int(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
const nct_itype itype) {
 ...
 *  ensure hash value within range for internal TYPE
 */
long hash_long(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
const nct_itype itype) {
 ...
 *  ensure hash value within range for internal TYPE
 */
float hash_float(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
const nct_itype itype) {
 ...
 *  ensure hash value within range for internal TYPE
 */
uint hash_uint(const int cdf_format,
const nc_type type,
const int rank,
const size_t *index,
const nct_itype itype) {
 ...
 */
int check_vars_text(const char *filename, int numVars) {
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_uchar(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
      ...
      if (inRange3(cdf_format, (double)expect, datatype, NCT_UCHAR) && (expect >= uchar_min && expect <= uchar_max)) {
        IF(err != NC_NOERR) {
          ...
          /* In put_vars(), nc_put_vara_double() is used to write
                     ...
                     */
          if (cdf_format < NC_FORMAT_CDF5 && var_type[i] == NC_BYTE && expect > schar_max)
            continue;
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_schar(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_short(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_int(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_long(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_float(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_double(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_ushort(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_uint(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_longlong(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 *  check all vars in file which are (text/numeric) compatible with TYPE
 */
int check_vars_ulonglong(const char *filename, int numVars) {
  int i, d, err, ncid, cdf_format, ndims;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  int dimids[MAX_RANK];
 ...
 */
int check_atts_text(int ncid, int numGatts, int numVars) {
 ...
 */
int check_atts_uchar(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
      ...
      for (k = 0; k < length; k++) {
        if (inRange3(cdf_format, (double)expect[k], datatype, NCT_UCHAR) && (expect[k] >= uchar_min && expect[k] <= uchar_max)) {
          /* In put_vars(), nc_put_vara_double() is used to write
                     ...
                     * values below for uchar APIs.
                     */
          if (cdf_format < NC_FORMAT_CDF5 && ATT_TYPE(i, j) == NC_BYTE && expect[k] > schar_max)
            continue;
 ...
 */
int check_atts_schar(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_short(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_int(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_long(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_float(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_double(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_ushort(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_uint(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_longlong(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
 ...
 */
int check_atts_ulonglong(int ncid, int numGatts, int numVars) {
  int i, j, cdf_format, err;
  int canConvert; /* Both text or both numeric */
  int nok = 0;    /* count of valid comparisons */
  size_t k, length, ndx[1];
...
int test_nc_put_var1_uchar(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  uchar value[1];
...
int test_nc_put_var1_schar(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  schar value[1];
...
int test_nc_put_var1_short(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  short value[1];
...
int test_nc_put_var1_long(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  long value[1];
...
int test_nc_put_var1_float(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  float value[1];
...
int test_nc_put_var1_double(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  double value[1];
...
int test_nc_put_var1_ushort(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  ushort value[1];
...
int test_nc_put_var1_uint(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  uint value[1];
...
int test_nc_put_var1_longlong(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  longlong value[1];
...
int test_nc_put_var1_ulonglong(void) {
  int i, err, ncid, cdf_format, nok = 0;
  int canConvert; /* Both text or both numeric */
  size_t j, index[MAX_RANK];
  ulonglong value[1];
...
int test_nc_put_var_uchar(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_var_schar(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_var_short(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_var_float(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_var_double(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_var_ushort(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_var_longlong(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_var_ulonglong(void) {
  int i, err, ncid, varid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, index[MAX_RANK];
...
int test_nc_put_vara_uchar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_schar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_short(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_long(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_float(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_double(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_ushort(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_uint(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_longlong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vara_ulonglong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, nels;
...
int test_nc_put_vars_uchar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_schar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_short(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_long(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_float(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_double(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_ushort(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_uint(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_longlong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_vars_ulonglong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_uchar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_schar(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_short(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_long(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_float(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_double(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_ushort(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_uint(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_longlong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_varm_ulonglong(void) {
  int i, k, d, err, nslabs, ncid, cdf_format, nok = 0;
  int canConvert;    /* Both text or both numeric */
  int allInExtRange; /* all values within external range? */
  size_t j, m, nels;
...
int test_nc_put_att_schar(void) {
  int i, j, err, ncid, cdf_format, nok = 0;
  int allInExtRange; /* all values within external range? */
  size_t k, ndx[1];
  schar value[MAX_NELS];
...
int test_nc_put_att_short(void) {
  int i, j, err, ncid, cdf_format, nok = 0;
  int allInExtRange; /* all values within external range? */
  size_t k, ndx[1];
  short value[MAX_NELS];
...
int test_nc_put_att_float(void) {
  int i, j, err, ncid, cdf_format, nok = 0;
  int allInExtRange; /* all values within external range? */
  size_t k, ndx[1];
  float value[MAX_NELS];
...
int test_nc_put_att_double(void) {
  int i, j, err, ncid, cdf_format, nok = 0;
  int allInExtRange; /* all values within external range? */
  size_t k, ndx[1];
  double value[MAX_NELS];
...
int test_nc_put_att_ushort(void) {
  int i, j, err, ncid, cdf_format, nok = 0;
  int allInExtRange; /* all values within external range? */
  size_t k, ndx[1];
  ushort value[MAX_NELS];
...
int test_nc_put_att_longlong(void) {
  int i, j, err, ncid, cdf_format, nok = 0;
  int allInExtRange; /* all values within external range? */
  size_t k, ndx[1];
  longlong value[MAX_NELS];
...
int test_nc_put_att_ulonglong(void) {
  int i, j, err, ncid, cdf_format, nok = 0;
  int allInExtRange; /* all values within external range? */
  size_t k, ndx[1];
  ulonglong value[MAX_NELS];
