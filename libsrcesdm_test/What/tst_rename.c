...
int create_test_file(char *path, int format) {
...
int check_file(int ncid, char *var0_name, char *var1_name, char *dim_name) {
  int varid;
  int var2id;
  int dimid;
  int lats_in[DIM_LEN];
 ...
 * #597. */
int check_charlies_file(char *file, char *dim_name, char *var_name) {
  int ncid;
  int varid, dimid;
 ...
 * test. */
int check_charlies_no_enddef_file(int ncid, char *dim_name, char *var_name) {
  int varid, dimid;
