...
I think it would be nice to insert here the codes for ESDM\_open and ESDM\_close. However, tcbcode is not spliting the code, so I just removed after expending some minutes on Google trying to fix it.
