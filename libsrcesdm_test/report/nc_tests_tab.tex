\tab
The directory {\textit{nc\_test4}} has originally 104 tests. The tests were classified according to their output using NetCDF. There are four categories for the tests:
...
\item[Not Working Build] It means it was not possible to compile the test.

\item[Not Working Run] It means the test compiles, but there is something wrong when the test runs and the expected output is not produced.
