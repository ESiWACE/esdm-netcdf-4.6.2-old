...
int add_attributes(int ncid, int varid, size_t num_atts, size_t att_len) {
...
/* Build the test file. */
int buildfile(size_t num_vars, size_t num_atts, size_t att_len,
char *file_name) {
  int ncid, varid;
  int dimids[NDIMS];
  int v;
...
int readfile(char *file_name, long long *delta, int do_inq, int num_vars) {
  int ncid;
...
int readfile_hdf5(char *file_name, long long *delta, int do_inq, int num_vars) {
