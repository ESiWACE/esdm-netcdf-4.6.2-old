 ...
 */
static int
numrecvars(ncid, recvarids) int ncid;
int *recvarids;
{
  int ndims, iv, nvars;
  int nrecvars;
 ...
 */
static int
recinq(ncid, nrecvars, recvarids, recsizes) int ncid;
int *nrecvars;
int *recvarids;
long *recsizes;
{
 ...
 */
static int
dimsizes(ncid, varid, sizes) int ncid;
int varid;
long *sizes;
{
  int ndims;
 ...
 */
static int
recput(ncid, recnum, datap) int ncid;
long recnum;
void **datap;
{
  int iv;
 ...
 */
static int
recget(ncid, recnum, datap) int ncid;
long recnum;
void **datap;
{
  int iv;
