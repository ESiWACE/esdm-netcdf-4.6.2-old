...
static const int
ILLEGAL_OPEN_FLAGS
= (NC_MMAP | NC_64BIT_OFFSET | NC_DISKLESS | NC_WRITE);

/** @internal NetCDF atomic type names. */
static const char *
nc_type_name_g[NUM_TYPES]
 ...
 * @author Ed Hartnett
 */
int NC_HDF4_open(const char *path, int mode, int basepe, size_t *chunksizehintp,
