...
static char *wordchars1 = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-+_/%\\";
static char *wordcharsn = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-+_/%\\";
...
void dcelexinit(char *input, DCElexstate **lexstatep) {
...
void dcelexcleanup(DCElexstate **lexstatep) {
