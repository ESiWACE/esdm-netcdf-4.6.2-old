...
int NCD2_close(int ncid, void *ignore) {
  NC *drno;
  NCDAPCOMMON *dapcomm;
...
int NCD2_inq_format_extended(int ncid, int *formatp, int *modep) {
  NC *nc;
...
*/
int NCD2_set_fill(int ncid, int fillmode, int *old_modep) {
  return THROW(NC_EPERM);
}

int NCD2_set_base_pe(int ncid, int pe) {
  return THROW(NC_EPERM);
}

int NCD2_def_dim(int ncid, const char *name, size_t len, int *idp) {
  return THROW(NC_EPERM);
}

int NCD2_put_att(int ncid, int varid, const char *name, nc_type datatype,
size_t len, const void *value, nc_type t) {
  return THROW(NC_EPERM);
}

int NCD2_def_var(int ncid, const char *name,
...
int NCD2_inq_base_pe(int ncid, int *pe) {
  NC *drno;
  int ret;
...
int NCD2_inq_format(int ncid, int *formatp) {
  NC *drno;
  int ret = NC_NOERR;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq(int ncid, int *ndimsp, int *nvarsp, int *nattsp, int *unlimdimidp) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_type(int ncid, nc_type p2, char *p3, size_t *p4) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_dimid(int ncid, const char *name, int *idp) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_dim(int ncid, int dimid, char *name, size_t *lenp) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_unlimdim(int ncid, int *unlimdimidp) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_rename_dim(int ncid, int dimid, const char *name) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_att(int ncid, int varid, const char *name,
...
int NCD2_inq_attid(int ncid, int varid, const char *name, int *idp) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_attname(int ncid, int varid, int attnum, char *name) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_rename_att(int ncid, int varid, const char *name, const char *newname) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_del_att(int ncid, int varid, const char *p3) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_get_att(int ncid, int varid, const char *name, void *value, nc_type t) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_var_all(int ncid, int varid, char *name, nc_type *xtypep,
...
int NCD2_inq_varid(int ncid, const char *name, int *varidp) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_rename_var(int ncid, int varid, const char *name) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_var_par_access(int ncid, int p2, int p3) {
  return THROW(NC_ENOPAR);
}

int NCD2_def_var_fill(int ncid, int p2, int p3, const void *p4) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_ncid(int ncid, const char *name, int *grp_ncid) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_show_metadata(int ncid) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_grps(int ncid, int *p2, int *p3) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_grpname(int ncid, char *p) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_grpname_full(int ncid, size_t *p2, char *p3) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_grp_parent(int ncid, int *p) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_grp_full_ncid(int ncid, const char *p2, int *p3) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_varids(int ncid, int *nvars, int *p) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_dimids(int ncid, int *ndims, int *p3, int p4) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_typeids(int ncid, int *ntypes, int *p) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_type_equal(int ncid, nc_type t1, int p3, nc_type t2, int *p5) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_user_type(int ncid, nc_type t, char *p3, size_t *p4, nc_type *p5,
size_t *p6, int *p7) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_typeid(int ncid, const char *name, nc_type *t) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_grp(int ncid, const char *p2, int *p3) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_rename_grp(int ncid, const char *p) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_compound(int ncid, size_t p2, const char *p3, nc_type *t) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_insert_compound(int ncid, nc_type t1, const char *p3, size_t p4, nc_type t2) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_insert_array_compound(int ncid, nc_type t1, const char *p3, size_t p4,
...
int NCD2_inq_compound_field(int ncid, nc_type xtype, int fieldid, char *name,
...
int NCD2_inq_compound_fieldindex(int ncid, nc_type xtype, const char *name,
int *fieldidp) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_vlen(int ncid, const char *p2, nc_type base_typeid, nc_type *t) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_put_vlen_element(int ncid, int p2, void *p3, size_t p4, const void *p5) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_get_vlen_element(int ncid, int p2, const void *p3, size_t *p4, void *p5) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_enum(int ncid, nc_type t1, const char *p3, nc_type *t) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_insert_enum(int ncid, nc_type t1, const char *p3, const void *p4) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_enum_member(int ncid, nc_type t1, int p3, char *p4, void *p5) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_inq_enum_ident(int ncid, nc_type t1, long long p3, char *p4) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_opaque(int ncid, size_t p2, const char *p3, nc_type *t) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_var_deflate(int ncid, int p2, int p3, int p4, int p5) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_var_fletcher32(int ncid, int p2, int p3) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_var_chunking(int ncid, int p2, int p3, const size_t *p4) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_var_endian(int ncid, int p2, int p3) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_def_var_filter(int ncid, int varid, unsigned int id, size_t n, const unsigned int *params) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_set_var_chunk_cache(int ncid, int p2, size_t p3, size_t p4, float p5) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
...
int NCD2_get_var_chunk_cache(int ncid, int p2, size_t *p3, size_t *p4, float *p5) {
  NC *drno;
  int ret;
  if ((ret = NC_check_id(ncid, (NC **)&drno)) != NC_NOERR) return THROW(ret);
