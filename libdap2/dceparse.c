...
void projections(DCEparsestate *state, Object list0) {
...
void selections(DCEparsestate *state, Object list0) {
  NClist *list = (NClist *)list0;
  if (list != NULL) {
...
int dceerror(DCEparsestate *state, char *msg) {
...
/* Wrapper for ceparse */
int dapceparse(char *input, DCEconstraint *constraint, char **errmsgp) {
  DCEparsestate *state;
  int errcode = 0;
