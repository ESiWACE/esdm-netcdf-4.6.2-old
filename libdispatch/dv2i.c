...
\param data type the data type of the variable.
...
\param data type pointer that will get variable data type.
\param ndims pointer that will get number of dimensions.
...
\param data type the type of the attribute.
...
\param varid the variable ID.
\param name the name of the attribute.
\param data type pointer that will get data type.
