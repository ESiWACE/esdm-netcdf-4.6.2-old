 ...
 * @author Ed Hartnett
 */
int NC4_set_var_chunk_cache(int ncid, int varid, size_t size, size_t nelems,
float preemption) {
  NC *nc;
  NC_GRP_INFO_T *grp;
  NC_FILE_INFO_T *h5;
 ...
 * @author Ed Hartnett
 */
int NC4_get_var_chunk_cache(int ncid, int varid, size_t *sizep,
 ...
 * @author Ed Hartnett
 */
int nc_get_var_chunk_cache_ints(int ncid, int varid, int *sizep,
 ...
 */
int NC4_inq_var_all(int ncid, int varid, char *name, nc_type *xtypep,
