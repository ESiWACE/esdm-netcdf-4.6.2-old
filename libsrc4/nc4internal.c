 ...
 */
int nc4_type_new(NC_GRP_INFO_T *grp, size_t size, const char *name, int assignedid,
NC_TYPE_INFO_T **type) {
 ...
 * @author Ed Hartnett
 */
int nc4_enum_member_add(NC_TYPE_INFO_T *parent, size_t size,
...
int log_metadata_nc(NC_FILE_INFO_T *h5) {
  ...
  h5->root_grp->nc4_info->controller->path,
