...
int NC4print(NCbytes *buf, int ncid) {
  int ret = NC_NOERR;
  NC4printer *out;
...
getNumericValue(union NUMVALUE numvalue, nc_type base) {
  switch (base) {
    case NC_CHAR:
    case NC_BYTE: return numvalue.i8[0];
    case NC_SHORT:
    case NC_USHORT: return numvalue.i16[0];
    case NC_INT:
    case NC_UINT: return numvalue.i32[0];
    case NC_INT64:
    case NC_UINT64: return numvalue.i64[0];
  }
