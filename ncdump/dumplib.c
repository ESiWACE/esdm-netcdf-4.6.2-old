 ...
 * necessary */
void sbuf_grow(safebuf_t *sb, size_t len) {
  size_t m = sb->len;
  void *tmp;
  assert(SAFEBUF_CHECK(sb));
  if (len <= m)
...
void sbuf_cpy(safebuf_t *sb, const char *s2) {
  size_t s2len;
  assert(SAFEBUF_CHECK(sb));
  s2len = strlen(s2);
...
void sbuf_cat(safebuf_t *sb, const char *s2) {
  size_t s2len;
  size_t res;
  assert(SAFEBUF_CHECK(sb));
  s2len = strlen(s2);
...
int ncbyte_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncchar_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncshort_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncint_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncfloat_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  float vv = *(float *)valp;
  if (isfinite(vv)) {
    int res;
...
int ncdouble_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
...
int ncubyte_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncushort_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncuint_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncint64_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncuint64_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
#ifdef USE_NETCDF4
int ncenum_typ_tostring(const nctype_t *typ, safebuf_t *sfbf, const void *valp) {
 ...
 * characters */
int ncopaque_typ_tostring(const nctype_t *typ, safebuf_t *sfbf,
const void *valp) {
...
int ncbyte_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncchar_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncshort_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncint_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncfloat_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  float vv = *(float *)valp;
  if (isfinite(vv)) {
    int res;
...
int ncdouble_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  double vv = *(double *)valp;
  if (isfinite(vv)) {
    int res;
...
static double to_double(const ncvar_t *varp, const void *valp) {
  double dd = 0.0;
  switch (varp->type) {
    case NC_BYTE:
      dd = *(signed char *)valp;
...
int ncubyte_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncushort_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncuint_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncint64_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncuint64_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  char sout[PRIM_LEN];
  int res;
...
int ncstring_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  return ncstring_typ_tostring(varp->tinfo, sfbf, valp);
}

#ifdef USE_NETCDF4
int ncenum_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  return ncenum_typ_tostring(varp->tinfo, sfbf, valp);
}

/* Convert an opaque value to a string, represented as hexadecimal
 * characters */
int ncopaque_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  return ncopaque_typ_tostring(varp->tinfo, sfbf, valp);
}

/* Convert a vlen value to a string, by using tostring function for base type */
int ncvlen_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
  return ncvlen_typ_tostring(varp->tinfo, sfbf, valp);
}

int nccomp_val_tostring(const ncvar_t *varp, safebuf_t *sfbf, const void *valp) {
 ...
 */
void get_type_name(int ncid, nc_type type, char *name) {
#ifdef USE_NETCDF4
