...
int listsetalloc(List *l, unsigned long sz) {
...
int listsetlength(List *l, unsigned long sz) {
  if (l == NULL) return FALSE;
...
int listset(List *l, unsigned long index, void *elem) {
  if (l == NULL) return FALSE;
...
int listinsert(List *l, unsigned long index, void *elem) {
...
int listcontains(List *l, void *elem) {
  unsigned long i;
...
int listelemremove(List *l, void *elem) {
  unsigned long len;
  unsigned long i;
  int found = 0;
