...
int NC3_def_dim(int ncid, const char *name, size_t size, int *dimidp) {
  int status;
  NC *nc;
  NC3_INFO *ncp;
  int dimid;
...
int NC3_inq_dim(int ncid, int dimid, char *name, size_t *sizep) {
  int status;
  NC *nc;
  NC3_INFO *ncp;
  NC_dim *dimp;
...
int NC3_rename_dim(int ncid, int dimid, const char *unewname) {
  int status = NC_NOERR;
  NC *nc;
  NC3_INFO *ncp;
  int existid;
