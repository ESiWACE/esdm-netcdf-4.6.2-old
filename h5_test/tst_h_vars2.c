...
#define ELEMENTS_NAME "Elements"
  {
    ...
    if (H5Pclose(fapl_id) < 0 || H5Pclose(gcpl_id) < 0 || H5Sclose(spaceid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0)
      ERR;
...
#define NAME_ATTRIBUTE "short"
  {
    ...
    if (H5Pclose(fapl_id) < 0 || H5Pclose(fcpl_id) < 0 || H5Sclose(dimscale_spaceid) < 0 || H5Fclose(fileid) < 0)
      ERR;
...
#define SIMPLE_VAR_NAME "data"
    ...
    if (H5Pclose(fapl_id) < 0 || H5Sclose(spaceid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0)
      ERR;
    ...
    if (H5Pclose(fapl_id) < 0 || H5Dclose(datasetid) < 0 || H5Sclose(spaceid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0)
      ERR;
  }
  SUMMARIZE_ERR;
...
#define ATT_NAME "_FillValue"
    ...
    if (f1.day != m.day || f1.elev != m.elev || f1.count != m.count || f1.relhum != m.relhum || f1.time != m.time) ERR;
    ...
    if (f2.day != m.day || f2.elev != m.elev || f2.count != m.count || f2.relhum != m.relhum || f2.time != m.time) ERR;

    if (H5Dclose(datasetid) < 0 || H5Aclose(attid) < 0 || H5Tclose(native_typeid) < 0 || H5Tclose(typeid) < 0 || H5Pclose(propid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
  SUMMARIZE_ERR;
