...
int main() {
...

  {
    ...
    /* Fold up our tents. */
    if (H5Dclose(dimscaleid) < 0 || H5Dclose(datasetid) < 0 || H5Sclose(spaceid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
...

  {
        ...
        case H5G_DATASET:
		   ...
		   * to the dataset's dimension 0. */
            ...
            if (H5DSiterate_scales(datasetid, 0, NULL, alien_visitor,
                &vars_dimscale_obj)
                < 0) ERR;
            if (vars_dimscale_obj.fileno[0] != dimscale_obj.fileno[0] || vars_dimscale_obj.objno[0] != dimscale_obj.objno[0] || vars_dimscale_obj.fileno[1] != dimscale_obj.fileno[1] || vars_dimscale_obj.objno[1] != dimscale_obj.objno[1]) ERR;
    ...
    /* Close up the shop. */
    if (H5Sclose(spaceid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
...
#define PRES_NAME "pres"
    ...
    /* Fold up our tents. */
    if (H5Dclose(lat_dimscaleid) < 0 || H5Dclose(lon_dimscaleid) < 0 || H5Dclose(pres_datasetid) < 0 || H5Sclose(lat_spaceid) < 0 || H5Sclose(lon_spaceid) < 0 || H5Sclose(pres_spaceid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
		   ...
		   * to the dataset's dimension 0 and 1. */
            ...
            for (d = 0; d < ndims; d++) {
		      ...
		      * for the lat and lon datasets. */
              if (vars_dimscale_obj[d].fileno[0] != dimscale_obj[d].fileno[0] || vars_dimscale_obj[d].objno[0] != dimscale_obj[d].objno[0]) ERR;
              if (vars_dimscale_obj[d].fileno[1] != dimscale_obj[d].fileno[1] || vars_dimscale_obj[d].objno[1] != dimscale_obj[d].objno[1]) ERR;
            }
          }
          if (H5Dclose(datasetid) < 0) ERR;
...
#define VNAME "v1"
    ...
    if (H5Pset_attr_creation_order(plistid2, H5P_CRT_ORDER_TRACKED | H5P_CRT_ORDER_INDEXED) < 0) ERR;
    ...
    /* Close down the show. */
    if (H5Pclose(fapl_id) < 0 || H5Pclose(fcpl_id) < 0 || H5Dclose(lat_dimscaleid) < 0 || H5Dclose(lon_dimscaleid) < 0 || H5Dclose(pres_datasetid) < 0 || H5Sclose(lat_spaceid) < 0 || H5Sclose(lon_spaceid) < 0 || H5Sclose(pres_spaceid) < 0 || H5Pclose(plistid) < 0 || H5Pclose(plistid2) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
    ...
    /* Check the dimension lengths. */
    {
      ...
      if (H5Dclose(datasetid) || H5Sclose(spaceid1)) ERR;
      ...
      if ((dataset_ndims = H5Sget_simple_extent_dims(spaceid1, h5dimlen,
           h5dimlenmax))
          < 0) ERR;
      if (dataset_ndims != 2 || h5dimlen[0] != 0 || h5dimlen[1] != 0 || h5dimlenmax[0] != H5S_UNLIMITED || h5dimlenmax[1] != H5S_UNLIMITED) ERR;
...
#define NUM_VALS 3
      ...
      if ((dataset_ndims = H5Sget_simple_extent_dims(file_spaceid, h5dimlen,
           h5dimlenmax))
          < 0) ERR;
      if (dataset_ndims != 2 || h5dimlen[0] != 1 || h5dimlen[1] != NUM_VALS || h5dimlenmax[0] != H5S_UNLIMITED || h5dimlenmax[1] != H5S_UNLIMITED) ERR;
      ...
      if ((dataset_ndims = H5Sget_simple_extent_dims(file_spaceid, h5dimlen,
           h5dimlenmax))
          < 0) ERR;
      if (dataset_ndims != 2 || h5dimlen[0] != 2 || h5dimlen[1] != NUM_VALS || h5dimlenmax[0] != H5S_UNLIMITED || h5dimlenmax[1] != H5S_UNLIMITED) ERR;

      /* All done. */
      if (H5Dclose(datasetid) || H5Sclose(mem_spaceid) || H5Sclose(file_spaceid)) ERR;
    }

    /* Close up the shop. */
    if (H5Sclose(spaceid)) ERR;
    if (H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
  SUMMARIZE_ERR;
...
#define LEN_NAME "u_len"
    ...
    /* Fold up our tents. */
    if (H5Dclose(lat_dimscaleid) < 0 || H5Dclose(lon_dimscaleid) < 0 || H5Dclose(time_dimscaleid) < 0 || H5Dclose(len_dimscaleid) < 0 || H5Dclose(pres_datasetid) < 0 || H5Sclose(lat_spaceid) < 0 || H5Sclose(lon_spaceid) < 0 || H5Sclose(time_spaceid) < 0 || H5Sclose(pres_spaceid) < 0 || H5Sclose(len_spaceid) < 0 || H5Pclose(fapl_id) < 0 || H5Pclose(fcpl_id) < 0 || H5Fclose(fileid) < 0) ERR;
