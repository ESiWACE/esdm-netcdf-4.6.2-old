...
int main() {
  ...
  printf("*** Checking HDF5 attribute deletes...");
  {
    ...
    /* Close everything. */
    if (H5Aclose(attid) < 0 || H5Sclose(spaceid) < 0 || H5Tclose(typeid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
  SUMMARIZE_ERR;
...

  {
    ...
    if (H5Sclose(spaceid) < 0 || H5Aclose(attid) < 0 || H5Aclose(attid1) < 0 || H5Tclose(typeid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
    ...
    if ((ndims = H5Sget_simple_extent_ndims(spaceid)) < 0) ERR;
    if (ndims != 0) ERR;
    if (H5Sclose(spaceid) < 0 || H5Aclose(attid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
...
#define MAX_SPEECH_LEN 4095
  {
    ...
    if (H5Dclose(datasetid) < 0 || H5Sclose(var_spaceid) < 0 || H5Sclose(spaceid) < 0 || H5Tclose(typeid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
    ...
    if (H5Dclose(datasetid) < 0 || H5Sclose(var_spaceid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
  }
...
#define DIM2_LEN 2
    ...
    if (H5Dclose(dimscaleid) < 0 || H5Sclose(spaceid) < 0 || H5Sclose(att_spaceid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
...
#define ATT_MAX_NAME 2
  {
    ...
    if (H5Sclose(att_spaceid) < 0 || H5Gclose(grpid) < 0 || H5Fclose(fileid) < 0) ERR;
